 ...
 @section('main')
     <div data-barba="container">
         ...
         @endif
         <div class="p-5 mx-auto text-gray-800 sm:p-10 md:px-16">
                 ...
                 <section class="relative text-gray-600 body-font">
                     <div class="container px-5 py-8 mx-auto">
                         <div class="flex flex-col w-full mb-4 text-center">
                             <h1 class="mb-2 text-2xl font-medium text-gray-800 sm:text-3xl title-font">Contactez Nous</h1>
                         </div>
                         <div class="mx-auto lg:w-1/2 md:w-2/3">
                             <form class="flex flex-wrap -m-2" method="post" action="contactmail" >
                                 ...
                                 <div class="w-1/2 p-2">
                                     <div class="relative">
                                         <label for="name" class="text-sm leading-7 text-gray-400">Nom</label>
