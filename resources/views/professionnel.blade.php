         ...
         <div class="container px-5 py-24 mx-auto">
             <div class="flex flex-wrap w-full mb-20">
                 <div class="w-full mb-6 lg:w-1/2 lg:mb-0">
                     <h1 class="mb-2 text-2xl font-medium text-gray-900 sm:text-3xl title-font">Liste des professionnels</h1>
                     <div class="h-1 bg-blue-500 rounded w-80"></div>
                 </div>
                 <p class="w-full leading-relaxed text-gray-500 lg:w-1/2">Whatever cardigan tote bag tumblr hexagon brooklyn
             ...
             <div class="flex flex-wrap -m-4">
                 <div class="p-4 xl:w-1/4 md:w-1/2">
                     <div class="p-6 bg-gray-100 rounded-lg">
                         ...
                         <p class="text-base leading-relaxed">Fingerstache flexitarian street art 8-bit waistcoat.</p>
                     </div>
                 </div>
                 <div class="p-4 xl:w-1/4 md:w-1/2">
                     <div class="p-6 bg-gray-100 rounded-lg">
